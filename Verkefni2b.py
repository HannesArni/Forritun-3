...
class Player:
    ...
    def move(self, dx, dy):
        ...
        # Þegar TOD lendir á skjöld bætist verður hann shielded og skjöldurinn hverfur
...
def main_game():
    ...
    for bomb in bombs:
        pygame.draw.rect(screen, TOMATO, bomb)

    # allir skildir teiknaðir
    for shield in shields:
        pygame.draw.rect(screen, STEELBLUE, shield)
    ...
    if tod.shield:
        pygame.draw.rect(screen, STEELBLUE, tod.rect)
    else:
        pygame.draw.rect(screen, GREENYELLOW, tod.rect)
